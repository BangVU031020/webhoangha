...
function randomString(n, t) {
    var i, r, u;
    for (t = t || "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789", i = "", r = 0; r < n; r++) u = Math.floor(Math.random() * t.length), i += t.substring(u, u + 1);
    return i
}
...
function productDetails() {
    var n = $.cookie("_city"),
        t;
    n && (t = "#city_" + n, $(t).length && marketFilters(n))
}
...
function validFormInstallment(n) {
    ...
    return i != "" || r ? $.toast({
        ...
        icon: "error",
        hideAfter: 1e4
    }) : (postValue = $(t).serializeObject(), $("#installmentForm button[type=submit]").text("ĐANG GỬI THÔNG TIN...").attr("disabled", "disabled"), $.post("/api/cart/installmentOrder", postValue, function (n) {
        if (n.Errors) $.toast({
...
function validFormQuickOrder(n) {
    ...
    return r != "" || f ? $.toast({
        ...
        t.push($(this).val())
    }), $("#quickForm #Promote").val(t.join(",")), $("#quickForm button[type=submit]").text("ĐANG GỬI THÔNG TIN...").attr("disabled", "disabled"), u = $(i).serializeObject(), $.post("/api/cart/quickorder", u, function (n) {
        n.Errors ? $.toast({
            heading: "Có lỗi khi gửi thông tin đơn hàng.",
            text: n.Message,
            showHideTransition: "fade",
...
function validFormQuickOrder_v2(n) {
    var r = $(n),
        t = validateForm(r),
        u = $(".g-recaptcha-response").val(),
        f, i, e;
    return u == null || u == "" ? (t += "Bạn cần tích chọn xác thực không phải người máy.", $("#g_captcha_container").css("border", "1px solid red")) : $("#g_captcha_container").css("border", "none"), f = $("#quickForm button[type=submit]").attr("disabled"), t != "" || f ? $.toast({
        heading: "Bạn cần kiểm tra lại thông tin.",
        text: t,
        showHideTransition: "fade",
        icon: "error",
        hideAfter: 1e4
    }) : (i = [], $("#quickFormPromote").find(":checked").each(function () {
        i.push($(this).val())
    }), $("#quickForm #Promote").val(i.join(",")), $("#quickForm button[type=submit]").text("ĐANG GỬI THÔNG TIN...").attr("disabled", "disabled"), e = $(r).serializeObject(), $.post("/api/cart/quickorder", e, function (n) {
        n.Errors ? $.toast({
            heading: "Có lỗi khi gửi thông tin đơn hàng.",
            text: n.Message,
            showHideTransition: "fade",
...
function validFormOrder_v2(n) {
    ...
    return r == null || r == "" ? (t += "Bạn cần tích chọn xác thực không phải người máy.", $("#g_captcha_container").css("border", "1px solid red")) : $("#g_captcha_container").css("border", "none"), t == "" ? (postValue = $(i).serializeObject(), $.post("/api/cart/checkout", postValue, function (n) {
        n.Errors ? $.toast({
            heading: "Có lỗi khi gửi thông tin đơn hàng.",
            text: n.Message,
            showHideTransition: "fade",
...
function outStockMessage() {
    ...
    t || i ? i && !t ? ($("p.out-noonline").show(), $("p.out-stock").hide()) : t && ($("p.out-stock").show(), $("p.out-noonline").hide()) : ($("p.out-stock").hide(), $("p.out-noonline").hide());
...
function marketFilters(n) {
    n == 0 ? $("#marketFilter .store ul li.instock").removeClass("hide") : ($("#marketFilter .store ul li").addClass("hide"), $("#marketFilter .store ul li.city_" + n).removeClass("hide"));
        ...
        function ho(n, t) {
            ...
            function fi(n, t) {
                ...
                if (t || (d = o.$FindChild(n, "bg"), rt = d && o.Lb(d)), !o.g(n, fu) && (t || !d)) {
                    ...
                    o.f(i, function (i) {
                        t < 3 && !v && o.hb(i, "u") == "image" && (v = i, v.border = 0, o.rb(v, ei), o.rb(n, ei), o.R(v, "maxWidth", "10000px"), o.O(d, v));
                        fi(i, t + 1)
                    });
        ...
        i.prototype = {
            ...
            suggest: function () {
                ...
                var t = this,
                    ...
                    s = u.groupBy,
                    a = u.formatResult,
                    i = t.getQuery(t.currentValue),
                    h = t.classes.suggestion,
                    v = t.classes.selected,
                    f = n(t.suggestionsContainer),
                    y = n(t.noSuggestionsContainer),
                    c = u.beforeRender,
                    e = "",
                    l = u.showLink,
                    o, p = function (n) {
                        var t = n.data[s];
                        return o === t ? "" : (o = t, u.formatGroup(n, o))
                    };
                if (i = sanitizeHTML(i), u.triggerSelectOnValidInput && t.isExactMatch(i)) {
                    t.select(0);
                    return
                }
                r = i.toLowerCase();
                (r.includes("samsung") || r.includes("ss") || r.includes("galaxy") || r.includes("fold") || r.includes("flip") || r.includes("s22")) && (e += '<div class="samsung-landing"><a href="/samsung"><img src="/Content/samsung/logo_samsung.png"/> <strong>Chuyên trang Samsung<\/strong><\/a><\/div>');
                n.each(t.suggestions, function (n, t) {
                    s && (e += p(t, i, n));
                    e += '<div onMouseDown="return false;" class="' + h + '" data-index="' + n + '">' + a(t, i, n) + "<\/div>"
                });
                this.adjustContainerWidth();
                y.detach();
                f.html(e);
                n.isFunction(c) && c.call(t.element, f, t.suggestions);
                l && f.append('<p class="more-results"><a href="' + l + i + '">Hiển thị kết quả cho <strong><i>' + i + "<\/i><\/strong><\/a><\/p>");
                t.fixPosition();
                f.show();
                u.autoSelectFirst && (t.selectedIndex = 0, f.scrollTop(0), f.children("." + h).first().addClass(v));
                t.visible = !0;
                t.findBestHint()
            },
        ...
        function u(t, r) {
            ...
            function c() {
                u.timer == 0 && (u.timer = setInterval(function () {
                    h(u.opts.direction)
                }, u.opts.interval), n(u.opts.controls.toggle).addClass("et-run").html(u.opts.controls.stopText))
            }
            ...
            function h(n) {
                var i, r, f, t, e;
                u.moving || u.elem.is(":visible") && (n == "up" ? (i = ":first-child", r = "-=", f = "appendTo") : (i = ":last-child", r = "+=", f = "prependTo"), t = u.targ.children(i), e = t.outerHeight(), typeof u.opts.callbacks.before == "function" && u.opts.callbacks.before.call(u, u.targ, t), u.moving = !0, u.targ.stop(!0, !0).animate({
                    top: r + e + "px"
            ...
            var u = this;
            if (u.opts = n.extend({}, f, r), u.elem = n(t), u.targ = n(t).children(":first-child"), u.timer = 0, u.moving = !1, v(), o(), w(), u.opts.mousePause) u.elem.on("mouseenter", function () {
                u.timerTemp = u.timer;
                e()
